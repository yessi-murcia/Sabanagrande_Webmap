var size = 0;
var placement = 'point';
function categories_RedVial_SG_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Afirmado sólido, dos o más vías':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Revestimiento suelto, transitable solo en verano':
                    return [ new ol.style.Style({
...
var style_RedVial_SG_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_RedVial_SG_2(feature, value, size, resolution, labelText,
